...
#define OPTIONS                                                                \
  ...
  OPTION(checkprooflrat, 1, 0, 1, 0, 0, 0, 0,                                  \
         "use internal LRAT proof checker")                                    \
  ...
  OPTION(conditionmaxeff, 1e7, 0, 2e9, 1, 0, 0, 1,                             \
         "maximum condition efficiency")                                       \
  OPTION(conditionmaxrat, 100, 1, 2e9, 1, 0, 0, 1,                             \
         "maximum clause variable ratio")                                      \
  OPTION(conditionmineff, 1e6, 0, 2e9, 1, 0, 0, 1,                             \
         "minimum condition efficiency")                                       \
  OPTION(conditionreleff, 100, 1, 1e5, 0, 0, 0, 1,                             \
  ...
  OPTION(eagersubsumelim, 20, 1, 1e3, 0, 0, 0, 1,                              \
         "limit on subsumed candidates")                                       \
  ...
  OPTION(reducetier1glue, 2, 1, 2e9, 0, 0, 0, 1,                               \
         "glue of kept learned clauses")                                       \
  ...
  OPTION(reluctantmax, 1048576, 0, 2e9, 0, 0, 0, 1,                            \
         "reluctant doubling period")                                          \
  ...
  OPTION(stabilizefactor, 200, 101, 2e9, 0, 0, 0, 1,                           \
         "phase increase in percent")                                          \
  OPTION(stabilizeint, 1e3, 1, 2e9, 0, 0, 0, 1, "stabilizing interval")        \
  OPTION(stabilizemaxint, 2e9, 1, 2e9, 0, 0, 0, 1,                             \
         "maximum stabilizing phase")                                          \
  ...
  OPTION(ternarymaxadd, 1e3, 0, 1e4, 1, 0, 0, 1,                               \
  ...
  OPTION(ternaryreleff, 10, 1, 1e5, 1, 0, 0, 1,                                \
         "relative efficiency per mille")                                      \
  ...
  OPTION(transredreleff, 1e2, 1, 1e5, 1, 0, 0, 1,                              \
         "relative efficiency per mille")                                      \
  ...
  OPTION(vivifyredeff, 75, 0, 1e3, 1, 0, 0, 1,                                 \
         "redundant efficiency per mille")                                     \
  OPTION(vivifyreleff, 20, 1, 1e5, 1, 0, 0, 1,                                 \
         "relative efficiency per mille")                                      \
