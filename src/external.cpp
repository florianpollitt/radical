...
External::External(Internal *i)
    : internal(i), max_var(0), vsize(0), extended(false), terminator(0),
      learner(0), solution(0), vars(max_var) {
  assert(internal);
...
bool External::failed_constraint() { return internal->failed_constraint(); }
